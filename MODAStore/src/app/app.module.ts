...
import { LoginComponent } from './component/admin/principal/login/login.component';
import { RegistroComponent } from './component/admin/principal/registro/registro.component';
